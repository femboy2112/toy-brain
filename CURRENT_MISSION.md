...
When the user tells Codex **`go`** in this repository, Codex should read this file and execute the current campaign.
...
This campaign is bounded to Phase 3.1 Osmotic Chamber work.
...
Then read whatever files the campaign step requires.
...
Do not skip ahead to later Phase 3.2+ work.
