...
FIXTURE_MODULES: list[str] = [
    ...
    "brain.ui.fixtures.coherence_feedback_static_audit",
    "brain.ui.fixtures.coherence_feedback_integration",
    "brain.ui.fixtures.developmental_milestone_m01",
    "brain.ui.fixtures.developmental_milestone_m02",
    "brain.ui.fixtures.developmental_milestone_m03",
    "brain.ui.fixtures.developmental_milestone_m04",
    "brain.ui.fixtures.developmental_milestone_m05",
    "brain.ui.fixtures.developmental_milestone_m06",
    "brain.ui.fixtures.developmental_milestone_m07",
    "brain.ui.fixtures.developmental_milestone_m08",
    "brain.ui.fixtures.developmental_milestone_m09",
    "brain.ui.fixtures.developmental_milestone_m10",
    "brain.ui.fixtures.developmental_milestone_static_audit",
    "brain.ui.fixtures.agent_repl_bridge_helpers",
    "brain.ui.fixtures.agent_loop_observation",
    "brain.ui.fixtures.agent_loop_reply_determinism",
    "brain.ui.fixtures.agent_loop_consciousness_refusal",
    "brain.ui.fixtures.agent_benchmark_pattern_axes",
    "brain.ui.fixtures.agent_benchmark_coherence_probe",
    "brain.ui.fixtures.agent_benchmark_repl_axes",
    "brain.ui.fixtures.agent_benchmark_session_continuity",
    "brain.ui.fixtures.agent_benchmark_runner_green",
    "brain.ui.fixtures.agent_loop_static_audit",
    "brain.ui.fixtures.agent_benchmark_static_audit",
    "brain.ui.fixtures.abstract_pattern_signature",
    "brain.ui.fixtures.learning_evidence_transfer",
    "brain.ui.fixtures.learning_evidence_records",
    "brain.ui.fixtures.learning_proof_report",
    "brain.ui.fixtures.learning_agent_loop_citation",
    "brain.ui.fixtures.learning_repl_correction",
    "brain.ui.fixtures.learning_diminishing_returns",
    "brain.ui.fixtures.reasoning_trace_construction",
    "brain.ui.fixtures.reasoning_trace_agent_loop",
    "brain.ui.fixtures.learning_reasoning_benchmark_axes",
    "brain.ui.fixtures.learning_reasoning_static_audit",
    "brain.ui.fixtures.dispatch_tracer_constructor",
    "brain.ui.fixtures.dispatch_tracer_session_stream",
    "brain.ui.fixtures.dispatch_tracer_processing_window",
    "brain.ui.fixtures.dispatch_tracer_step_tick_error",
    "brain.ui.fixtures.dispatch_tracer_noop",
    "brain.ui.fixtures.dispatch_tracer_agent_loop_integration",
    "brain.ui.fixtures.dispatch_tracer_reasoning_learning_integration",
    "brain.ui.fixtures.dispatch_tracer_benchmark_axis",
    "brain.ui.fixtures.dispatch_tracer_static_audit",
    "brain.ui.fixtures.worldlet_feedback_summary_helper",
    "brain.ui.fixtures.worldlet_feedback_mode_validation",
    "brain.ui.fixtures.worldlet_feedback_session_step",
    "brain.ui.fixtures.worldlet_feedback_dispatch_trace",
    "brain.ui.fixtures.worldlet_feedback_reasoning_learning",
    "brain.ui.fixtures.worldlet_feedback_agent_loop",
    "brain.ui.fixtures.worldlet_feedback_benchmark_axis",
    "brain.ui.fixtures.worldlet_feedback_static_audit",
    "brain.ui.fixtures.osmotic_probe_constructor",
    "brain.ui.fixtures.osmotic_probe_control",
    "brain.ui.fixtures.osmotic_probe_true_exposure",
    "brain.ui.fixtures.osmotic_probe_transfer",
    "brain.ui.fixtures.osmotic_probe_sham",
    "brain.ui.fixtures.osmotic_probe_distractor",
    "brain.ui.fixtures.osmotic_probe_delayed",
    "brain.ui.fixtures.osmotic_probe_learning_reasoning_dispatch",
    "brain.ui.fixtures.osmotic_probe_runner_green",
    "brain.ui.fixtures.osmotic_probe_static_audit",
    "brain.ui.fixtures.active_hypothesis_constructor",
    "brain.ui.fixtures.active_hypothesis_enumerator",
    "brain.ui.fixtures.active_hypothesis_safe_probe",
    "brain.ui.fixtures.active_hypothesis_control",
    "brain.ui.fixtures.active_hypothesis_single",
    "brain.ui.fixtures.active_hypothesis_multi",
    "brain.ui.fixtures.active_hypothesis_nosurvivor",
    "brain.ui.fixtures.active_hypothesis_reuse",
    "brain.ui.fixtures.active_hypothesis_learning_reasoning_dispatch",
    "brain.ui.fixtures.active_hypothesis_runner_green",
    "brain.ui.fixtures.active_hypothesis_static_audit",
    "brain.ui.fixtures.curriculum_constructor",
    "brain.ui.fixtures.curriculum_enumerator",
    "brain.ui.fixtures.curriculum_single",
    "brain.ui.fixtures.curriculum_noninterfering",
    "brain.ui.fixtures.curriculum_interfering",
    "brain.ui.fixtures.curriculum_decay",
    "brain.ui.fixtures.curriculum_reuse",
    "brain.ui.fixtures.curriculum_false_pos_neg",
    "brain.ui.fixtures.curriculum_learning_reasoning_dispatch",
    "brain.ui.fixtures.curriculum_runner_green",
    "brain.ui.fixtures.curriculum_static_audit",
    "brain.ui.fixtures.proto_speech_inventory",
    "brain.ui.fixtures.proto_speech_feedback_evidence",
    "brain.ui.fixtures.proto_speech_babble_ambient",
    "brain.ui.fixtures.proto_speech_reinforcement_correction",
    "brain.ui.fixtures.proto_speech_suppression_pressure",
    "brain.ui.fixtures.proto_speech_holophrase_transfer",
    "brain.ui.fixtures.proto_speech_two_token_combination",
    "brain.ui.fixtures.proto_speech_turn_taking_refusal",
    ...
    "brain.ui.fixtures.llm_cache_parse_failure",
    "brain.ui.fixtures.llm_cache_bounds_artifacts",
