...
def check_worldlet_feedback_benchmark_green() -> None:
    ...
    # Full battery: twelve axes in canonical order. Phase 3.25
    # widens the battery beyond WORLDLET_FEEDBACK with the
    # OSMOTIC_LEARNING axis; WORLDLET_FEEDBACK is still present
