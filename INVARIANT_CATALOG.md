...
- **REQUIRED v0.10 invariants:** 123
- **STRUCTURAL (constructor- or type-enforced, not per-tick asserted):** 41
...
- **OBSERVED row-level:** 6 (recorded in run summary, not gating)

Total tabular entries: 186. v0.10 success is gated by the 123 REQUIRED rows + 41 STRUCTURAL rows (OBSERVED rows are logged but do not gate; the I-CAT-01 runner audit gates separately at startup).
